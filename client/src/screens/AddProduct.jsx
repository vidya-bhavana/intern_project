...
const AddProduct = ({ history }) => {
    ...
    return (
        <>
            <Container className='mt-5 p-2 bg-info text-dark '>
                ...
                <Form.Group controlId="fileName" className="mb-3">
                    ...
                    <Button className="btn btn-light border-dark text-dark " type="submit">
                        Add Product
                    </Button>
                    &nbsp;
                    <button className='btn btn-light border-dark'>
                        <Link class="text-dark border-dark" style={{textDecoration:"none"}} to="/">Back</Link>
                    </button>
                </Form>
            </Container>
        </>
